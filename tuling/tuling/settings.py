...
# Scrapy settings for tuling project
#
...
SPIDER_MODULES = ['tuling.spiders']
NEWSPIDER_MODULE = 'tuling.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'tuling (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'tuling.middlewares.TulingSpiderMiddleware': 543,
#}

# Enable or disable downloader middlewares
# See https://doc.scrapy.org/en/latest/topics/downloader-middleware.html
#DOWNLOADER_MIDDLEWARES = {
#    'tuling.middlewares.TulingDownloaderMiddleware': 543,
#}
...
#ITEM_PIPELINES = {
#    'tuling.pipelines.TulingPipeline': 300,
#}
