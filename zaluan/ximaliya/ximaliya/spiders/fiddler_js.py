...
# this
# file is named
# SampleRules.js and it is in the
# //  \Program
# Files\Fiddler\ folder.When
# Fiddler
# first
# runs, it
# creates
...
# // CustomRules.js
# inside
# your \Documents\Fiddler2\Scripts
# folder.If
# you
# make
# a
...
# addons.Get
# it
# here: http: // fiddler2.com / r /?SYNTAXVIEWINSTALL
#
# // GLOBALIZATION
# NOTE: Save
# this
...
#
#
# class . Pretty much everything you ever add to FiddlerScript
#
# // belongs
# right
# inside
...
# custom - bound
# column
# for the Web Sessions list.
# // See
# http: // fiddler2.com / r /?fiddlercolumns
# for more info
#     / *
# public
# static
...
# function
# FillMethodColumn(oS: Session): String
# {
...
# static
# function
# FlagsReport(arrSess: Session[]):String
# {
# var
# oSB: System.Text.StringBuilder = new
...
# static
# function
# DoLinksMenu(sText: String, sAction: String)
# {
...
# Accept - Language
# header
# with one of the defined values
...
# with one of the defined values
# // The page http://
#     browserscope2.org / browse?category = selectors & ua = Mobile % 20
# Safari is a
# good
# place
# to
...
# RulesStringValue(14, "Edge (Win10)",
...
# RulesStringValue(16, "&Firefox 3.6",
...
# RulesStringValue(22, "ChromeBook",
...
# RulesStringValue(24, "Kindle Fire (Silk)",
...
# var
# m_SimulateModem: boolean = false;
#
# // Removes
# HTTP - caching
# related
# headers and specifies
# "no-cache"
# on
...
# var
# m_DisableCaching: boolean = false;
#
# public
# static
# RulesOption("Cache Always &Fresh", "Per&formance")
# var
# m_AlwaysFresh: boolean = false;
#
# // Force
# a
# manual
...
# function
# DoRemoveEncoding(oSessions: Session[]) {
...
# POSTs
# to
# fiddler2.com in italics
# // if (oSession.HostnameIs("www.fiddler2.com") & & oSession.HTTPMethodIs("POST")) {oSession["ui-italic"] = "yup";}
#
# // Sample
# Rule: Break
# requests
# for URLs containing "/sandbox/"
...
#
# if (m_AlwaysFresh & & (
#         oSession.oRequest.headers.Exists("If-Modified-Since") | | oSession.oRequest.headers.Exists("If-None-Match")))
#     {
...
#     // been
#     read
#     from the client.This is typically
#     too
#     early
#     to
#     do
...
#     body
#     hasn
#     't yet been read, but sometimes it may be useful.
#     //
#     // For
#     instance, see
#     // http: // blogs.msdn.com / b / fiddler / archive / 2011 / 11 / 05 / http - expect -
#     continue
#     -delays - transmitting - post - bodies - by - up - to - 350 - milliseconds.aspx
#     // for one useful thing you can do with this handler.
#     //
#     // Note: oSession.requestBodyBytes is not available
#     within
#     this
#     function!
#     / *
...
#         var
#     sProc = ("" + oSession["x-ProcessInfo"]).ToLower();
...
#     // to
#     disable
#     streaming(oSession.bBufferResponse = true) if there is something in the response headers
#     // which
#     suggests
#     that
#     tampering
#     with the response body is necessary.
#     //
#     // Note: oSession.responseBodyBytes is not available
#     within
#     this
#     function!
#     //
#     static
#     function
#     OnPeekAtResponseHeaders(oSession: Session) {
#                                                // FiddlerApplication.Log.LogFormat(
#         "Session {0}: Response header peek shows status is {1}", oSession.id, oSession.responseCode);
#     if (m_DisableCaching) {
...
#     static
#     function
#     OnReturningError(oSession: Session) {
#     }
#     * /
#     / *
#     // This
...
#     are
#     used
#     for simple breakpointing & other QuickExec rules
...
#     static
#     var
#     bpResponseURI: String = null;
#
#     BindPref("fiddlerscript.ephemeral.bpMethod")
#     public
#     static
#     var
#     bpMethod: String = null;
#
#     static
#     var
#     bpStatus: int = -1;
#     static
#     var
#     uiBoldURI: String = null;
#     static
#     var
#     gs_ReplaceToken: String = null;
#     static
#     var
#     gs_ReplaceTokenWith: String = null;
#     static
#     var
#     gs_OverridenHost: String = null;
#     static
#     var
#     gs_OverrideHostWith: String = null;
#
#     // The
#     OnExecAction
#     function is called
...
#         static
#     function
#     OnExecAction(sParams: String[]): Boolean
#     {
#
#     FiddlerObject.StatusText = "ExecAction: " + sParams[0];
#
#     var
#     sAction = sParams[0].toLowerCase();
#     switch(sAction)
#     {
#         case
#     "bold":
#     if (sParams.Length < 2) {uiBoldURI=null; FiddlerObject.StatusText="Bolding cleared";
#     return false;}
#     uiBoldURI = sParams[1];
...
#     case
#     "bps":
#     if (sParams.Length < 2) {bpStatus=-1; FiddlerObject.StatusText="Response Status breakpoint cleared";
#     return false;}
...
#     case
#     "bpm":
#     if (sParams.Length < 2) {bpMethod=null; FiddlerObject.StatusText="Request Method breakpoint cleared";
#     return false;}
...
#     case
#     "bpu":
#     if (sParams.Length < 2) {bpRequestURI=null; FiddlerObject.StatusText="RequestURI breakpoint cleared";
#     return false;}
...
#     case
#     "bpafter":
#     if (sParams.Length < 2) {bpResponseURI=null; FiddlerObject.StatusText="ResponseURI breakpoint cleared";
#     return false;}
...
#     case
#     "overridehost":
#     if (sParams.Length < 3) {gs_OverridenHost=null; FiddlerObject.StatusText="Host Override cleared";
#     return false;}
...
#     case
#     "urlreplace":
#     if (sParams.Length < 3) {gs_ReplaceToken=null; FiddlerObject.StatusText="URL Replacement cleared";
#     return false;}
#     gs_ReplaceToken = sParams[1];
#     gs_ReplaceTokenWith = sParams[2].Replace(" ", "%20"); // Simple
#     helper
...
#     case
#     "keeponly":
#     if (sParams.Length < 2) {FiddlerObject.StatusText="Please specify Content-Type to retain during wipe.";
#     return false;}
...
#         "http://www.google.com/search?hl=en&btnI=I%27m+Feeling+Lucky&q=" + Utilities.UrlEncode(sParams[1]));
#     return true;
#     case
#     "help":
...
#     case
#     "tail":
#     if (sParams.Length < 2) {FiddlerObject.StatusText="Please specify # of sessions to trim the session list to.";
#     return false;}
